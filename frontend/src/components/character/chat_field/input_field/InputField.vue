...
<template>
  <form v-if="!showMic" @submit.prevent="handleSend" class="absolute bottom-4 left-2 h-12 w-90 flex items-center">
    <input
        ref="input-ref"
        v-model="message"
        ...
        placeholder="文本输入..."
    >
    <div @click="handleSend" class="absolute right-1 w-8 h-8 flex justify-center items-center cursor-pointer">
      <SendIcon />
    </div>
