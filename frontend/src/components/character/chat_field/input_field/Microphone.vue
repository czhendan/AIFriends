...
<template>
  <div class="absolute bottom-4 left-2 h-12 w-90 flex items-center bg-black/30 backdrop-blur-sm rounded-2xl">
    ...
    <div @click="emit('close')" class="absolute right-1 w-8 h-8 flex justify-center items-center cursor-pointer">
      <KeyboardIcon />
    </div>
  </div>
</template>
